...
def render_dispatch_workspace() -> None:
    ...
    if st.button("Execute Multi-Agent Dispatch", use_container_width=True, type="primary"):
        # This calls our new decoupled engine
...
def _render_executive_tabs(result: dict) -> None:
    """Renders the high-level project data inside the glass UI."""
